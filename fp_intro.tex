...
\institute{\href{http://www.meetup.com/Scala-Jozi/events/170835742/}{Scala Jozi}}
\date{May 5, 2014}
...
\begin{frame}{A simple programming example}
  ...
  Say I give you an array of integers, and I want every one of them doubled, how would you write it?
...
\begin{frame}{A simple programming example}
  ...
  Sorry, I forgot to mention that you cannot mutate any collection.
...
\begin{frame}{A simple programming example}
  ...
  Looking much better, but you also can't vary any of your variables.
