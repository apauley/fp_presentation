...
\begin{frame}{Programming Paradigms}
  ...
  \begin{tikzpicture}[
    ...
    \node (i) at (0,0) {Imperative};
    \node (d) at (5.5,0) {Declarative};

    \node (proc) at (0,3.5) {Procedural};
    \node (oo)   at (0,2.5) {Object-Oriented};

    \node (fp)    at (5.5,3.5) {\alert{Functional}};
    \node (logic) at (5.5,2.5) {Logic};
  \end{tikzpicture}
\end{frame}
...
\begin{frame}{Fold/Reduce/Inject}
...
\begin{frame}[fragile]{Fold}
  ...
  \inputminted[fontsize=\large,firstline=54,lastline=59]{haskell}{code/haskell/accounts.hs}
...
\begin{frame}{Programming Paradigms}
  ...
  \begin{tikzpicture}[
    ...
    \node (i) at (0,0) {\alert{Imperative}};
    \node (d) at (5.5,0) {Declarative};

    \node (proc) at (0,3.5) {Procedural};
    \node (oo)   at (0,2.5) {Object-Oriented};

    \node (fp)    at (5.5,3.5) {Functional};
    \node (logic) at (5.5,2.5) {Logic};
  \end{tikzpicture}
\end{frame}
