...
\begin{frame}{Online Courses}
  ...
  \begin{description}
  \item [School of Haskell, FPComplete]
    \url{https://www.fpcomplete.com/school}
  \item [Functional Programming Principles in Scala, EPFL University]
    \url{https://www.coursera.org/course/progfun}
  \item [Programming Languages, University of Washington]
