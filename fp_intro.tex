...
\section{A Few Challenges}

\begin{frame}{Less loops, more map/filter/fold}

  {\Huge Join the anti-while campaign}
...
\begin{frame}{Shun your objects}
  ...
  \vskip5mm
  {\Large Get re-usability with higher-order functions.}
