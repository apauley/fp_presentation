...
\begin{frame}{Student Data}
  ...
  \inputminted[firstline=1,lastline=3]{haskell}{code/haskell/studentfilter.hs}
...
\begin{frame}{Student Data}
  ...
  \inputminted[firstline=9,lastline=20,gobble=11]{haskell}{code/haskell/studentmap.hs}
...
Map on student data:
  \inputminted[firstline=6,lastline=7]{haskell}{code/haskell/studentmap.hs}
...
Filter on student data:
  \inputminted[firstline=8,lastline=12]{haskell}{code/haskell/studentfilter.hs}
