...
\begin{frame}[fragile]{A functional program consists entirely of functions}
  ...
  \begin{verbatim}
./justfunctions.py Hello FP from Python
2013-09-11 23:18:20.569190 Hello-FP-from-Python
  \end{verbatim}

  \inputminted[firstline=6,lastline=12]{python}{code/justfunctions.py}
...
\begin{frame}[fragile]{A functional program consists entirely of functions}
  ...
  \begin{verbatim}
./justfunctions Hello FP from Haskell
2013-09-11 21:18:52.346109 UTC Hello-FP-from-Haskell
  \end{verbatim}

  \inputminted[firstline=5]{haskell}{code/justfunctions.hs}
...
Fold on student data:
  \inputminted[firstline=10,lastline=14]{haskell}{code/studentfold.hs}
...
\begin{frame}{Shortened Map, Filter, Fold}
  ...
  \inputminted[firstline=8,lastline=15]{haskell}{code/studentmapfilterfoldshort.hs}
