...
\begin{frame}[fragile]{A functional program consists entirely of functions}
  ...
  \inputminted[firstline=6,lastline=15]{python}{code/justfunctions.py}
...
\begin{frame}[fragile]{Recursive function: Python}
  ...
  \inputminted[firstline=3,lastline=9]{python}{code/doubleall_recursion.py}
...
In Python:
  \inputminted[firstline=3,lastline=4]{python}{code/doubleall_map.py}
\end{frame}
